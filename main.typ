...
=== Sensor Bait#set page("a5", background: image("assets/backdrop.png", fit: "stretch"))
#set document(author: "Artur Roos", title: "Zedmech")
#set text(font: "Exo 2", size: 12pt)
...
=== Shield
Reduce incoming damage by 1, but not lower than 1. Ignored on crits.
...
Once per turn. When another Mech fires its Overwatch you may fire too. Applies to both friendly and enemy Mechs. Applies after all the effects of the first shot were resolved.
...
=== Deployable Drone
1 Heat. Place a small drone on an adjacent #hex. They are considered levitating. It activates with this Mech. Considered to be 2HP/4H/4M/0S with a Cannon. Activates on the same turn as the creator Mech and uses its actions, but all the drones activate at once. May not Overwatch, automatically vent at the end of their turn. Destroyed when overheating. Does not trigger Overwatch when emerging. Do not brawl.

A Mech may only have #sym.floor.l HP / 2 - 1#sym.floor.r drones at a time.
...
Once per turn you may reroll a 1. On a hit gain the heat again.
